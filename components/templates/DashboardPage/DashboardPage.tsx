    ...
    return (
        <section className={styles.dashboard}>
            <div className={`container ${styles.dashboard__container}`}>
                ...
                <h2 className={`${styles.dashboard__title} ${darkModeClass}`}>Кроссовки</h2>
                ...
                <div className={styles.dashboard__about}>
                    ...
                    <p className={`${styles.dashboard__about__text} ${darkModeClass}`}>
                        Мы - команда энтузиастов, которые разделяют страсть к кроссовкам и моде.
                        Наша компания начала свой путь с целью предоставить нашим клиентам
                        лучший выбор качественной обуви для спорта, активного отдыха и
                        повседневной носки.
                        Мы работаем над тем, чтобы наш
                        ассортимент был всегда свежим и разнообразным, чтобы удовлетворить
                        запросы каждого нашего клиента. Мы тщательно
                        отбираем бренды и модели, уделяя особое внимание
                        качеству материалов, дизайну и инновационным технологиям.</p>
                </div>
            </div>
        </section>
    )
